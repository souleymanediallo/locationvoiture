...
!function() {
    ...
    null != (r = document.querySelector(".navbar.fixed-top")) && (r.classList,
    t = function(e) {
        20 < e.currentTarget.pageYOffset ? r.classList.add("navbar-stuck") : r.classList.remove("navbar-stuck")
    }
    ,
    ...
    function() {
        for (var o = document.querySelectorAll('[data-bs-toggle="select"]'), e = 0; e < o.length; e++)
            !function(e) {
                for (var t = o[e].querySelectorAll(".dropdown-item"), r = o[e].querySelector(".dropdown-toggle-label"), a = o[e].querySelector('input[type="hidden"]'), n = 0; n < t.length; n++)
    ...
    function(e, t, r) {
        ...
        var r = null != t.dataset.carouselOptions && "vertical" === JSON.parse(t.dataset.carouselOptions).axis ? ['<i class="fi-chevron-up"></i>', '<i class="fi-chevron-down"></i>'] : ['<i class="fi-chevron-left"></i>', '<i class="fi-chevron-right"></i>']
          , a = {
            container: t,
            controlsText: r,
            navPosition: "bottom",
        ...
        var r = Object.assign({}, a, o)
          ...
          , o = (a.querySelectorAll(".tns-item"),
        n.getInfo())
          , i = a.querySelector(".tns-current-slide")
          , r = a.querySelector(".tns-total-slides");
        a.classList.contains("tns-center") && (t = o.index,
        ...
        null !== a.querySelector(".tns-slides-count") && (i.innerHTML = o.displayIndex,
        ...
        if (0 !== u.length)
            for (var p, e = 0; e < u.length; e++)
                !function(c) {
                    ...
                    if (e && "" !== e) {
                        var r = JSON.parse(e)
                          , a = r.mapLayer || "https://api.maptiler.com/maps/voyager/{z}/{x}/{y}.png?key=5vRQzd34MMsINEyeKPIs"
                          , n = r.coordinates || [0, 0]
                          , o = r.zoom || 1
        ...
        if (0 !== a.length)
            for (var e = 0; e < a.length; e++)
                !function(e) {
                    ...
                    "SELECT" === a[e].tagName ? a[e].addEventListener("change", function(e) {
                        t.innerText = e.target.value
                    }) : a[e].classList.contains("date-picker") ? a[e].addEventListener("change", function(e) {
                        "" !== e.target.value ? t.innerText = e.target.value : t.innerText = r
